 ...
 * limitations under the License.
 */
Yc.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Yc.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){Ml="9.0.0",ha(new Ko("database",((e,{instanceIdentifier:t})=>Wp(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ga("@firebase/database","0.12.0",e)}();export{Or as A,Vn as F,ai as a,pt as b,ei as c,oi as d,ci as e,fi as f,ui as g,Ol as h,_a as i,Bp as j,Mp as k,Op as l,Ap as m,a as n,Qn as o,jp as p,Rn as q,Wn as r,dt as s,l as t,Nr as u,xr as v,kt as w,Dp as x,lo as y,ds as z};
