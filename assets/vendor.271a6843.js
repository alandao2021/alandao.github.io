 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Jh,Xh;class Zh{constructor(){this.views=new Map}}function ed(e,t,n,i){const r=t.source.queryId;if(null!==r){const s=e.views.get(r);return bo(null!=s,"SyncTree gave us an op for an invalid query."),Yh(s,t,n,i)}{let r=[];for(const s of e.views.values())r=r.concat(Yh(s,t,n,i));return r}}function td(e,t,n,i,r,s){const o=function(e,t,n,i,r){const s=t._queryIdentifier,o=e.views.get(s);if(!o){let e=kh(n,r?i:null),s=!1;e?s=!0:i instanceof Iu?(e=xh(n,i),s=!1):(e=Iu.EMPTY_NODE,s=!1);const o=ih(new eh(e,s,!1),new eh(i,r,!1));return new zh(t,o)}return o}(e,t,i,r,s);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){const n=e.viewCache_.eventCache,i=[];n.getNode().isLeafNode()||n.getNode().forEachChild(_u,((e,t)=>{i.push(Ru(e,t))}));return n.isFullyInitialized()&&i.push(Nu(n.getNode())),Qh(e,i,n.getNode(),t)}(o,n)}function nd(e,t,n,i){const r=t._queryIdentifier,s=[];let o=[];const a=ad(e);if("default"===r)for(const[l,c]of e.views.entries())o=o.concat(Gh(c,n,i)),Kh(c)&&(e.views.delete(l),c.query._queryParams.loadsAllData()||s.push(c.query));else{const t=e.views.get(r);t&&(o=o.concat(Gh(t,n,i)),Kh(t)&&(e.views.delete(r),t.query._queryParams.loadsAllData()||s.push(t.query)))}return a&&!ad(e)&&s.push(new(bo(Jh,"Reference.ts has not been loaded"),Jh)(t._repo,t._path)),{removed:s,events:o}}function id(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function rd(e,t){let n=null;for(const i of e.views.values())n=n||Hh(i,t);return n}function sd(e,t){if(t._queryParams.loadsAllData())return ld(e);{const n=t._queryIdentifier;return e.views.get(n)}}function od(e,t){return null!=sd(e,t)}function ad(e){return null!=ld(e)}function ld(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cd=1;class ud{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ch(null),this.pendingWriteTree_={visibleWrites:uh.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function hd(e,t,n,i,r){return function(e,t,n,i,r){bo(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=hh(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?gd(e,new Xu({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function dd(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Ch(e.pendingWriteTree_,t)){let t=new ch(null);return null!=i.snap?t=t.set(Mc(),!0):lc(i.children,(e=>{t=t.set(new Dc(e),!0)})),gd(e,new Qu(i.path,t,n))}return[]}function pd(e,t,n){return gd(e,new Xu({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function fd(e,t,n,i){const r=t._path,s=e.syncPointTree_.get(r);let o=[];if(s&&("default"===t._queryIdentifier||od(s,t))){const a=nd(s,t,n,i);0===s.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(r));const l=a.removed;o=a.events;const c=-1!==l.findIndex((e=>e._queryParams.loadsAllData())),u=e.syncPointTree_.findOnPath(r,((e,t)=>ad(t)));if(c&&!u){const t=e.syncPointTree_.subtree(r);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&ad(t)){return[ld(t)]}{let e=[];return t&&(e=id(t)),lc(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,s=wd(e,i);e.listenProvider_.startListening(Sd(r),bd(e,r),s.hashFn,s.onComplete)}}}if(!u&&l.length>0&&!i)if(c){const n=null;e.listenProvider_.stopListening(Sd(t),n)}else l.forEach((t=>{const n=e.queryToTagMap.get(Cd(t));e.listenProvider_.stopListening(Sd(t),n)}));!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=Cd(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,l)}return o}function _d(e,t,n){const i=t._path;let r=null,s=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Vc(e,i);r=r||rd(t,n),s=s||ad(t)}));let o,a=e.syncPointTree_.get(i);if(a?(s=s||ad(a),r=r||rd(a,Mc())):(a=new Zh,e.syncPointTree_=e.syncPointTree_.set(i,a)),null!=r)o=!0;else{o=!1,r=Iu.EMPTY_NODE;e.syncPointTree_.subtree(i).foreachChild(((e,t)=>{const n=rd(t,Mc());n&&(r=r.updateImmediateChild(e,n))}))}const l=od(a,t);if(!l&&!t._queryParams.loadsAllData()){const n=Cd(t);bo(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=cd++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let c=td(a,t,n,bh(e.pendingWriteTree_,i),r,o);if(!l&&!s){const n=sd(a,t);c=c.concat(function(e,t,n){const i=t._path,r=bd(e,t),s=wd(e,n),o=e.listenProvider_.startListening(Sd(t),r,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(i);if(r)bo(!ad(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!$c(e)&&t&&ad(t))return[ld(t).query];{let e=[];return t&&(e=e.concat(id(t).map((e=>e.query)))),lc(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(Sd(i),bd(e,i))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return c}function md(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=rd(n,Vc(e,t));if(i)return i}));return Sh(i,t,r,n,!0)}function gd(e,t){return yd(t,e.syncPointTree_,null,bh(e.pendingWriteTree_,Mc()))}function yd(e,t,n,i){if($c(e.path))return vd(e,t,n,i);{const r=t.get(Mc());null==n&&null!=r&&(n=rd(r,Mc()));let s=[];const o=Fc(e.path),a=e.operationForChild(o),l=t.children.get(o);if(l&&a){const e=n?n.getImmediateChild(o):null,t=Oh(i,o);s=s.concat(yd(a,l,e,t))}return r&&(s=s.concat(ed(r,e,i,n))),s}}function vd(e,t,n,i){const r=t.get(Mc());null==n&&null!=r&&(n=rd(r,Mc()));let s=[];return t.children.inorderTraversal(((t,r)=>{const o=n?n.getImmediateChild(t):null,a=Oh(i,t),l=e.operationForChild(t);l&&(s=s.concat(vd(l,r,o,a)))})),r&&(s=s.concat(ed(r,e,i,n))),s}function wd(e,t){const n=t.query,i=bd(e,n);return{hashFn:()=>(function(e){return e.viewCache_.serverCache.getNode()}(t)||Iu.EMPTY_NODE).hash(),onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=Id(e,n);if(i){const n=Ed(i),r=n.path,s=n.queryId,o=Vc(r,t);return Td(e,r,new Ju(Yu(s),o))}return[]}(e,n._path,i):function(e,t){return gd(e,new Ju({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return fd(e,n,null,i)}}}}function bd(e,t){const n=Cd(t);return e.queryToTagMap.get(n)}function Cd(e){return e._path.toString()+"$"+e._queryIdentifier}function Id(e,t){return e.tagToQueryMap.get(t)}function Ed(e){const t=e.indexOf("$");return bo(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Dc(e.substr(0,t))}}function Td(e,t,n){const i=e.syncPointTree_.get(t);bo(i,"Missing sync point for query tag that we're tracking");return ed(i,n,bh(e.pendingWriteTree_,t),null)}function Sd(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(bo(Xh,"Reference.ts has not been loaded"),Xh)(e._repo,e._path):e}class kd{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new kd(t)}node(){return this.node_}}class xd{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=Bc(this.path_,e);return new xd(this.syncTree_,t)}node(){return md(this.syncTree_,this.path_)}}const Pd=function(e,t,n){return e&&"object"==typeof e?(bo(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Nd(e[".sv"],t,n):"object"==typeof e[".sv"]?Rd(e[".sv"],t):void bo(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Nd=function(e,t,n){switch(e){case"timestamp":return n.timestamp;default:bo(!1,"Unexpected server value: "+e)}},Rd=function(e,t,n){e.hasOwnProperty("increment")||bo(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const i=e.increment;"number"!=typeof i&&bo(!1,"Unexpected increment value: "+i);const r=t.node();if(bo(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;const s=r.getValue();return"number"!=typeof s?i:s+i},Ad=function(e,t,n){return Od(e,new kd(t),n)};function Od(e,t,n){const i=e.getPriority().val(),r=Pd(i,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const i=e,s=Pd(i.getValue(),t,n);return s!==i.getValue()||r!==i.getPriority().val()?new fu(s,Tu(r)):e}{const i=e;return s=i,r!==i.getPriority().val()&&(s=s.updatePriority(new fu(r))),i.forEachChild(_u,((e,i)=>{const r=Od(i,t.getImmediateChild(e),n);r!==i&&(s=s.updateImmediateChild(e,r))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dd{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Md(e,t){let n=t instanceof Dc?t:new Dc(t),i=e,r=Fc(n);for(;null!==r;){const e=jo(i.node.children,r)||{children:{},childCount:0};i=new Dd(r,i,e),n=qc(n),r=Fc(n)}return i}function Fd(e){return e.node.value}function Ld(e,t){e.node.value=t,Bd(e)}function qd(e){return e.node.childCount>0}function jd(e,t){lc(e.node.children,((n,i)=>{t(new Dd(n,e,i))}))}function Ud(e,t,n,i){n&&!i&&t(e),jd(e,(e=>{Ud(e,t,!0,i)})),n&&i&&t(e)}function Wd(e){return new Dc(null===e.parent?e.name:Wd(e.parent)+"/"+e.name)}function Bd(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===Fd(e)&&!qd(e)}(n),r=qo(e.node.children,t);i&&r?(delete e.node.children[t],e.node.childCount--,Bd(e)):i||r||(e.node.children[t]=n.node,e.node.childCount++,Bd(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const $d=/[\[\].#$\/\u0000-\u001F\u007F]/,Vd=/[\[\].#$\u0000-\u001F\u007F]/,zd=function(e){return"string"==typeof e&&0!==e.length&&!$d.test(e)},Hd=function(e){return"string"==typeof e&&0!==e.length&&!Vd.test(e)},Kd=function(e,t,n,i){i&&void 0===t||Gd(zo(e,"value"),t,n)},Gd=function(e,t,n){const i=n instanceof Dc?new Kc(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Yc(i));if("function"==typeof t)throw new Error(e+"contains a function "+Yc(i)+" with contents = "+t.toString());if(ec(t))throw new Error(e+"contains "+t.toString()+" "+Yc(i));if("string"==typeof t&&t.length>10485760/3&&Ho(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Yc(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(lc(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!zd(t)))throw new Error(e+" contains an invalid key ("+t+") "+Yc(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=Ho(a),Gc(o),Gd(e,s,i),function(e){const t=e.parts_.pop();e.byteLength_-=Ho(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&r)throw new Error(e+' contains ".value" child '+Yc(i)+" in addition to actual children.")}},Yd=function(e,t,n,i){if(!(i&&void 0===n||Hd(n)))throw new Error(zo(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Qd=function(e,t){if(".info"===Fc(t))throw new Error(e+" failed = Can't modify data under /.info/")},Jd=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!zd(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Hd(e)}(n))throw new Error(zo(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Xd{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Zd(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||zc(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function ep(e,t,n){Zd(e,n),np(e,(e=>zc(e,t)))}function tp(e,t,n){Zd(e,n),np(e,(e=>Hc(e,t)||Hc(t,e)))}function np(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(ip(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function ip(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Kl&&Yl("event: "+n.toString()),dc(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rp{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Xd,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Bu(),this.transactionQueueTree_=new Dd,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function sp(e,t,n){if(e.stats_=Ic(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Uu(e.repoInfo_,((t,n,i,r)=>{lp(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>cp(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Fo(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}e.persistentConnection_=new Jc(e.repoInfo_,t,((t,n,i,r)=>{lp(e,t,n,i,r)}),(t=>{cp(e,t)}),(t=>{!function(e,t){lc(t,((t,n)=>{up(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return Cc[n]||(Cc[n]=t()),Cc[n]}(e.repoInfo_,(()=>new Hu(e.stats_,e.server_))),e.infoData_=new Wu,e.infoSyncTree_=new ud({startListening:(t,n,i,r)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=pd(e.infoSyncTree_,t._path,o),setTimeout((()=>{r("ok")}),0)),s},stopListening:()=>{}}),up(e,"connected",!1),e.serverSyncTree_=new ud({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,((n,i)=>{const s=r(n,i);tp(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function op(e){const t=e.infoData_.getNode(new Dc(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function ap(e){return(t=(t={timestamp:op(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function lp(e,t,n,i,r){e.dataUpdateCount++;const s=new Dc(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r)if(i){const t=Wo(n,(e=>Tu(e)));o=function(e,t,n,i){const r=Id(e,i);if(r){const i=Ed(r),s=i.path,o=i.queryId,a=Vc(s,t),l=ch.fromObject(n);return Td(e,s,new Zu(Yu(o),a,l))}return[]}(e.serverSyncTree_,s,t,r)}else{const t=Tu(n);o=function(e,t,n,i){const r=Id(e,i);if(null!=r){const i=Ed(r),s=i.path,o=i.queryId,a=Vc(s,t);return Td(e,s,new Xu(Yu(o),a,n))}return[]}(e.serverSyncTree_,s,t,r)}else if(i){const t=Wo(n,(e=>Tu(e)));o=function(e,t,n){const i=ch.fromObject(n);return gd(e,new Zu({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,s,t)}else{const t=Tu(n);o=pd(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=gp(e,s)),tp(e.eventQueue_,a,o)}function cp(e,t){up(e,"connected",t),!1===t&&function(e){fp(e,"onDisconnectEvents");const t=ap(e),n=Bu();Vu(e.onDisconnect_,Mc(),((i,r)=>{const s=function(e,t,n,i){return Od(t,new xd(n,e),i)}(i,r,e.serverSyncTree_,t);$u(n,i,s)}));let i=[];Vu(n,Mc(),((t,n)=>{i=i.concat(pd(e.serverSyncTree_,t,n));const r=Cp(e,t);gp(e,r)})),e.onDisconnect_=Bu(),tp(e.eventQueue_,Mc(),i)}(e)}function up(e,t,n){const i=new Dc("/.info/"+t),r=Tu(n);e.infoData_.updateSnapshot(i,r);const s=pd(e.infoSyncTree_,i,r);tp(e.eventQueue_,i,s)}function hp(e){return e.nextWriteId_++}function dp(e,t,n,i,r){fp(e,"set",{path:t.toString(),value:n,priority:i});const s=ap(e),o=Tu(n,i),a=md(e.serverSyncTree_,t),l=Ad(o,a,s),c=hp(e),u=hd(e.serverSyncTree_,t,l,c,!0);Zd(e.eventQueue_,u),e.server_.put(t.toString(),o.val(!0),((n,i)=>{const s="ok"===n;s||Zl("set at "+t+" failed: "+n);const o=dd(e.serverSyncTree_,c,!s);tp(e.eventQueue_,t,o),function(e,t,n,i){t&&dc((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let r=e;i&&(r+=": "+i);const s=new Error(r);s.code=e,t(s)}}))}(0,r,n,i)}));const h=Cp(e,t);gp(e,h),tp(e.eventQueue_,h,[])}function pp(e,t,n){let i;i=".info"===Fc(t._path)?fd(e.infoSyncTree_,t,n):fd(e.serverSyncTree_,t,n),ep(e.eventQueue_,t._path,i)}function fp(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Yl(n,...t)}function _p(e,t,n){return md(e.serverSyncTree_,t,n)||Iu.EMPTY_NODE}function mp(e,t=e.transactionQueueTree_){if(t||bp(e,t),Fd(t)){const n=vp(e,t);bo(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),r=_p(e,t,i);let s=r;const o=r.hash();for(let c=0;c<n.length;c++){const e=n[c];bo(0===e.status,"tryToSendTransactionQueue_: items in queue should all be run."),e.status=1,e.retryCount++;const i=Vc(t,e.path);s=s.updateChild(i,e.currentOutputSnapshotRaw)}const a=s.val(!0),l=t;e.server_.put(l.toString(),a,(i=>{fp(e,"transaction put response",{path:l.toString(),status:i});let r=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,r=r.concat(dd(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();bp(e,Md(e.transactionQueueTree_,t)),mp(e,e.transactionQueueTree_),tp(e.eventQueue_,t,r);for(let e=0;e<i.length;e++)dc(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Zl("transaction at "+l.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}gp(e,t)}}),o)}(e,Wd(t),n)}else qd(t)&&jd(t,(t=>{mp(e,t)}))}function gp(e,t){const n=yp(e,t),i=Wd(n);return function(e,t,n){if(0===t.length)return;const i=[];let r=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const l=t[a],c=Vc(n,l.path);let u,h=!1;if(bo(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)h=!0,u=l.abortReason,r=r.concat(dd(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)h=!0,u="maxretry",r=r.concat(dd(e.serverSyncTree_,l.currentWriteId,!0));else{const n=_p(e,l.path,s);l.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){Gd("transaction failed: Data returned ",i,l.path);let t=Tu(i);"object"==typeof i&&null!=i&&qo(i,".priority")||(t=t.updatePriority(n.getPriority()));const o=l.currentWriteId,a=ap(e),c=Ad(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=c,l.currentWriteId=hp(e),s.splice(s.indexOf(o),1),r=r.concat(hd(e.serverSyncTree_,l.path,c,l.currentWriteId,l.applyLocally)),r=r.concat(dd(e.serverSyncTree_,o,!0))}else h=!0,u="nodata",r=r.concat(dd(e.serverSyncTree_,l.currentWriteId,!0))}tp(e.eventQueue_,n,r),r=[],h&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;bp(e,e.transactionQueueTree_);for(let a=0;a<i.length;a++)dc(i[a]);mp(e,e.transactionQueueTree_)}(e,vp(e,n),i),i}function yp(e,t){let n,i=e.transactionQueueTree_;for(n=Fc(t);null!==n&&void 0===Fd(i);)i=Md(i,n),n=Fc(t=qc(t));return i}function vp(e,t){const n=[];return wp(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function wp(e,t,n){const i=Fd(t);if(i)for(let r=0;r<i.length;r++)n.push(i[r]);jd(t,(t=>{wp(e,t,n)}))}function bp(e,t){const n=Fd(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Ld(t,n.length>0?n:void 0)}jd(t,(t=>{bp(e,t)}))}function Cp(e,t){const n=Wd(yp(e,t)),i=Md(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{Ip(e,t)})),Ip(e,i),Ud(i,(t=>{Ip(e,t)})),n}function Ip(e,t){const n=Fd(t);if(n){const i=[];let r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(bo(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(bo(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(dd(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?Ld(t,void 0):n.length=s+1,tp(e.eventQueue_,Wd(t),r);for(let e=0;e<i.length;e++)dc(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Sp{constructor(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}getPath(){const e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Fo(this.snapshot.exportVal())}}class kp{constructor(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pp{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return $c(this._path)?null:jc(this._path)}get ref(){return new Np(this._repo,this._path)}get _queryIdentifier(){const e=ju(this._queryParams),t=oc(e);return"{}"===t?"default":t}get _queryObject(){return ju(this._queryParams)}isEqual(e){if(!((e=Go(e))instanceof Pp))return!1;const t=this._repo===e._repo,n=zc(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class Np extends Pp{constructor(e,t){super(e,t,new Lu,!1)}get parent(){const e=Wc(this._path);return null===e?null:new Np(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class Rp{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Dc(e),n=Op(this.ref,e);return new Rp(this._node.getChild(t),n,_u)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Rp(n,Op(this.ref,t),_u))))}hasChild(e){const t=new Dc(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ap(e,t){return(e=Go(e))._checkNotDeleted("ref"),void 0!==t?Op(e._root,t):e._root}function Op(e,t){var n,i,r,s;return null===Fc((e=Go(e))._path)?(n="child",i="path",s=!1,(r=t)&&(r=r.replace(/^\/*\.info(\/|$)/,"/")),Yd(n,i,r,s)):Yd("child","path",t,!1),new Np(e._repo,Bc(e._path,t))}function Dp(e,t){e=Go(e),Qd("push",e._path),Kd("push",t,e._path,!0);const n=op(e._repo),i=Pu(n),r=Op(e,i),s=Op(e,i);let o;return o=null!=t?function(e,t){e=Go(e),Qd("set",e._path),Kd("set",t,e._path,!1);const n=new xo;return dp(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}(s,t).then((()=>s)):Promise.resolve(s),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}class Mp{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new Sp("value",this,new Rp(e.snapshotNode,new Np(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new kp(this,e,t):null}matches(e){return e instanceof Mp&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class Fp{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new kp(this,e,t):null}createEvent(e,t){bo(null!=e.childName,"Child events should have a childName.");const n=Op(new Np(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new Sp(e.type,this,new Rp(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Fp&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function Lp(e,t,n,i,r){let s;if("object"==typeof i&&(s=void 0,r=i),"function"==typeof i&&(s=i),r&&r.onlyOnce){const t=n,i=(n,i)=>{pp(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new xp(n,s||void 0),a="value"===t?new Mp(o):new Fp(t,o);return function(e,t,n){let i;i=".info"===Fc(t._path)?_d(e.infoSyncTree_,t,n):_d(e.serverSyncTree_,t,n),ep(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>pp(e._repo,e,a)}function qp(e,t,n,i){return Lp(e,"child_added",t,n,i)}!function(e){bo(!Jh,"__referenceConstructor has already been defined"),Jh=e}(Np),function(e){bo(!Xh,"__referenceConstructor has already been defined"),Xh=e}(Np);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const jp={};function Up(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||Xl("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Yl("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=Ep(s,r),c=l.repoInfo;"undefined"!=typeof process&&(a=process.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${c.namespace}`,l=Ep(s,r),c=l.repoInfo):o=!l.repoInfo.secure;const u=r&&o?new mc(mc.OWNER):new _c(e.name,e.options,t);Jd("Invalid Firebase Database URL",l),$c(l.path)||Xl("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,i){let r=jp[t.name];r||(r={},jp[t.name]=r);let s=r[e.toURLString()];s&&Xl("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new rp(e,false,n,i),r[e.toURLString()]=s,s}(c,e,u,new fc(e.name,n));return new Wp(h,e)}class Wp{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(sp(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Np(this._repo,Mc())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=jp[t];n&&n[e.key]===e||Xl(`Database ${t}(${e.repoInfo_}) has already been deleted.`),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Xl("Cannot call "+e+" on a deleted database.")}}function Bp(e=ya(),t){return fa(e,"database").getImmediate({identifier:t})}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
Jc.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Jc.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){Ll="9.0.0",pa(new Yo("database",((e,{instanceIdentifier:t})=>Up(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),va("@firebase/database","0.12.0",e)}();export{Nr as A,Dp as B,lo as C,ds as D,Or as E,Vn as F,ai as a,pt as b,ei as c,oi as d,ci as e,tt as f,fi as g,mt as h,ui as i,ga as j,Ml as k,Bp as l,ho as m,a as n,Qn as o,Jt as p,Zt as q,Wn as r,qp as s,l as t,uo as u,Op as v,Ap as w,kt as x,Rn as y,xr as z};
